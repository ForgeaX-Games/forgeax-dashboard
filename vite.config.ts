// Standalone dashboard dev server — self-contained build config OWNED by this
// package (not imported from interface). Defaults to :18934; override
// FORGEAX_DASHBOARD_PORT.
//
...
export default defineConfig({
  ...
  server: {
    port: Number(process.env.FORGEAX_DASHBOARD_PORT ?? 18934),
    host: '0.0.0.0',
    strictPort: true,
    open: false,

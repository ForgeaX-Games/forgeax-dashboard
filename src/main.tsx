// Standalone dashboard app entry — OWNS its own boot, mirroring
...
// rendered here. We mount just <Dashboard/> full-viewport over the booted L1
// store.
...
function boot(): void {
  ...
  createRoot(rootEl).render(
    <StrictMode>
      <ErrorBoundary scope="dashboard-standalone">
        <BrandProvider>
